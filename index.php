...
<meta name="description" content="Virtual healthcare for everyone. Telemedicine consultations in one click at your home. Call 469-805-4561 to schedule a tele-visit." >
...
<meta property="og:description" content="Virtual healthcare for everyone. Telemedicine consultations in one click at your home. Call 469-805-4561 to schedule a tele-visit.">
...
<meta name="twitter:description" content="Virtual healthcare for everyone. Telemedicine consultations in one click at your home. Call 469-805-4561 to schedule a tele-visit.">
          ...
          <div class="row ">
            <div class="col-md-4 margin-bottom">
              ...
              <p class="c-content sm-text-center text-center custom-fonts custom-call"> Call us at </p>
                ...
                <a hreflang="en" href="tel:+1469-805-4561" class="links cta-secondary"> 469-805-4561 </a>
...
<a href="tel:+1469-805-4561" ref="" class="new-padding btn-new c-btn-border-opacity-04 yop c-btn btn-no-focus c-btn-header btn btn-lg c-btn-border-1x c-btn-dark c-btn-circle c-btn-sbold buttons-bolder">Start a visit</a>
</div>
  ...
  <div class="container">
    <div class="row" style="margin-bottom: 8rem;margin-top: 5rem;">
      <div class="col-md-6 col-ls-6 col-sm-12">
        <div class="visit-button-holder">
          <a href="tel:+1469-805-4561" ref="" class="new-padding btn-new c-btn-border-opacity-04 yop c-btn btn-no-focus c-btn-header btn btn-lg c-btn-border-1x c-btn-dark c-btn-circle c-btn-sbold buttons-bolder" style="width: 100%;height: 100px;">Complementary Hospital<br> Telemedicine Business Model<br> Consultation</a>
        </div>
      </div>
      <div class="col-md-6 col-ls-6 col-sm-12">
            ...
            <div class="col-md-12">
                <div class="carousel slide" data-ride="carousel" id="quote-carousel">
                    ...
                    <ol class="carousel-indicators">
                        <li data-target="#quote-carousel" data-slide-to="0" class="active"><img class="img-responsive " src="http://specialtycarelive.com/assets/images/Andy400x400.png" alt="LUCILLE">
                        </li>
                        <li data-target="#quote-carousel" data-slide-to="1"><img class="img-responsive" src="http://specialtycarelive.com/assets/images/LinkedIn-Profile-Picture-Example-Rachel-Montañez.jpeg" alt="MYRA">
                        </li>
                        <li data-target="#quote-carousel" data-slide-to="2"><img class="img-responsive" src="http://specialtycarelive.com/assets/images/Brian-Smith-400x400.jpg" alt="HICKS">
                        </li>
                        <li data-target="#quote-carousel" data-slide-to="3"><img class="img-responsive" src="http://specialtycarelive.com/assets/images/18_JesseSmith-Appelson-400x400.jpg" alt="TINA">
                        </li>
                    </ol>
